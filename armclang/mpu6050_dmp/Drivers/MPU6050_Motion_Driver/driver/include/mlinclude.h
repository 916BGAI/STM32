...
#define INVENSENSE_FUNC_START __pragma(message(__FILE__ "|"__FUNCTION__)) int dslkQjDsd = functionEnterLog(__FILE__, __FUNCTION__)
#endif // COVERAGE
#endif // WIN32
...
#define return \
    if (profileExit(__FILE__, __FUNCTION__)) return
#endif // PROFILE
